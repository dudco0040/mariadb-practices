...
-- 문제4.
-- 현재 근무하고 있는 직원 수는 몇 명입니까? (salaries 테이블을 사용합니다.)   - 현재 !! where 999-01-01 
...
-- 문제6.
-- 현재 부서 매니저는 몇 명이나 있나요?(역임 매너저는 제외) - 과거 기록 없애고 현재꺼만  현재 매니저만 세라~  999인 애들 ?
...
-- 문제11
-- 사번이 13250(Zeydy)인 지원이 직책 변경 상황을 시간순으로 출력해보세요. 직책 테이블에 가서 뽑아서 최근순으로 직책이 어땠는지 출력
